...
class TrainTest():
    ...
    def predict_on_crops(self, entire_images_path, window=50, stride=20):
        ...
        for count, each_image_path in enumerate(entire_images_path):
            ...
            SWAP = create_crops_of_entire_Image(each_image_path, '/home/batool/beam_selection/image/swap', window, stride)
            ...
            np.save('/home/batool/beam_selection/image/npys/'+each_image_path.split('/')[-1].split('.')[0]+'.npy',vote_shape)
